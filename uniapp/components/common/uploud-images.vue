		...
		<view class="uni-list-cell cell-pd">
			<view class="uni-uploader">
				...
				<view class="uni-uploader-body">
					<view class="uni-uploader_files">
						<block v-for="(image,index) in imageList" :key="index">
							<view class="uni-uploader_file">
								<view class="icon iconfont icon-shanchu" @tap="delect(index)">
									
								</view>
								<image class="uni-uploader_img" :src="image" :data-src="image" @tap="previewImage"></image>
							</view>
						</block>
						<view class="uni-uploader_input-box">
							<view class="uni-uploader_input" @tap="chooseImage">
